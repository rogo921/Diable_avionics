    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        if(hullmodswitched)
        {
            ...
            tooltip.addPara(txt("hm_switchsub_cf03A01")
                    +txt("hm_switchsub_cf03A02"),pad,Misc.getHighlightColor(),"900","300","150");
            ...
            tooltip.addPara(
                    txt("hm_switchsub_cf03B01")+"\n"+
                            txt("hm_switchsub_cf03B02")+txt("hm_switchsub_cf03B03"),pad,Misc.getHighlightColor(),"2000","25%","40%"
            );
        }
