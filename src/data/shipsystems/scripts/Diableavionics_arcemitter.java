...
public class Diableavionics_arcemitter extends MagicSubsystem{
    ...
    public boolean shouldActivateAI(float amount) {
        ...
        if (!ship.getFluxTracker().isOverloadedOrVenting()) {
            ...
            List<ShipAPI> potentialEnemy = AIUtils.getNearbyEnemies(ship,900);
            ...
            if(arctick.intervalElapsed()){
                ...
                if(Targets.isEmpty()) {
                    ...
                    for (int k=0;k<3;k++){
                        ...
                        Vector2f randompoint = MathUtils.getPoint(ship.getLocation(),900*MathUtils.getRandomNumberInRange(0.25f,0.9f),
